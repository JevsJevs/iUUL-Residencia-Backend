...
namespace ValidacaoCliente {
    internal class Validator {
        ...
        Erro ValidaNascimento(string dataNasc) {
        ...
        Erro ValidaDependente(string num) {
        ...
        //public List<Erro> ValidaDados(List<>) {
